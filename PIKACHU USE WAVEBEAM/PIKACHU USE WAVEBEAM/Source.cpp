...

{
	...
	al_clear_to_color(al_map_rgb(20, 80, 100));
...

	{
		...
		if (ev.type == ALLEGRO_EVENT_TIMER) {
			...
			if (shootBeam) {
				...
				// 2 changes the frequency (stretched/shrunk)
				// 16 shifts the beam on the x axis

				// 10 changes the amplitude of the wave
				// 0.5 
				// 16 shifts vertically
